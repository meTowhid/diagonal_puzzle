...
import 'package:very_good_slide_puzzle/layout/puzzle_board.dart';
...
class SimplePuzzleLayoutDelegate extends PuzzleLayoutDelegate {
  ...
  @override
  Widget boardBuilder(int size, List<PuzzleTile> tiles) {
    return Column(
      children: [
        const ResponsiveGap(
          small: 32,
        ...
        ResponsiveLayoutBuilder(
          small: (_, __) => SizedBox.square(
            ...
            child: SimplePuzzleBoard(
              ...
              spacing: 5,
              tileSize:
                  _BoardSize.small / size - 5, // subtract the spacing value
            ),
          ),
          medium: (_, __) => SizedBox.square(
            ...
            child: SimplePuzzleBoard(
              ...
              spacing: 8,
              tileSize:
                  _BoardSize.medium / size - 8, // subtract the spacing value
            ),
          ),
          large: (_, __) => SizedBox.square(
            ...
            child: SimplePuzzleBoard(
              ...
              spacing: 8,
              tileSize:
                  _BoardSize.large / size - 8, // subtract the spacing value
            ),
          ),
        ),
        const ResponsiveGap(
...
class SimplePuzzleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isLastTapped = tile.value == state.lastTappedTile?.value;
    ...
    return AnimatedContainer(
      ...
      child: TextButton(
          ...
          backgroundColor: MaterialStateProperty.resolveWith<Color?>(
            (states) {
              if (tile.value == state.lastTappedTile?.value) {
                return theme.pressedColor.withOpacity(.01);
              } else if (states.contains(MaterialState.hovered)) {
                return theme.hoverColor.withOpacity(.1);
              } else {
        ...
        child: Transform.rotate(
          ...
          child: Text(
            tile.value.toString(),
            // '${tile.correctPosition.x},${tile.correctPosition.y}',
            style: const TextStyle(color: PuzzleColors.primary2),
          ),
        ),
      ),
    );
